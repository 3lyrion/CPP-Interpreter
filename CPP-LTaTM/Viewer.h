...
//	}
//
//	inline Context::Type getType(Token::Type type) const
//	{
//		auto context_type = Context::Type::String;
//		if      (type == Token::Type::Keyword) context_type = Context::Type::Bool;
//		else if (type == Token::Type::FloatLiteral) context_type = Context::Type::Float;
//		else if (type == Token::Type::IntLiteral)  context_type = Context::Type::Int;
//
//		return context_type;
//	}
//
